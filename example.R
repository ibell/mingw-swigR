...
`fact` = function(n, .copy = FALSE)
{
  ...
  ;.Call('R_swig_fact', n, as.logical(.copy), PACKAGE='example');
  
}

attr(`fact`, 'returnType') = 'integer'
attr(`fact`, "inputTypes") = c('integer')
class(`fact`) = c("SWIGFunction", class('fact'))
